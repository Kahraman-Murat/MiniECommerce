...
{
    public class ChangeShowcaseImageCommadHandler : IRequestHandler<ChangeShowcaseImageCommadRequest, ChangeShowcaseImageCommadResponse>
    {
        readonly IProductImageFileWriteRepository _productImageFileWriteRepository;

        public ChangeShowcaseImageCommadHandler(IProductImageFileWriteRepository productImageFileWriteRepository)
        {
            _productImageFileWriteRepository = productImageFileWriteRepository;
        }

        public async Task<ChangeShowcaseImageCommadResponse> Handle(ChangeShowcaseImageCommadRequest request, CancellationToken cancellationToken)
        {
