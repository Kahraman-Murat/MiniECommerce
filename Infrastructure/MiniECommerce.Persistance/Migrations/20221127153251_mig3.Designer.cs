...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("MiniECommerce.Domain.Entities.Endpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.BasketItem", b =>
                {
                    b.HasOne("MiniECommerce.Domain.Entities.Basket", "Basket")
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.CompletedOrder", b =>
                {
                    b.HasOne("MiniECommerce.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("MiniECommerce.Domain.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("MiniECommerce.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("MiniECommerce.Domain.Entities.Order", b =>
                {
                    b.HasOne("MiniECommerce.Domain.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("MiniECommerce.Domain.Entities.Order", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
